...
public class ExemploOrdenacaoMap {
    public static void main(String[] args) {
       ...
       Set<Map.Entry<String, Livro>> meusLivros4 = new TreeSet<>(new ComparatorNumeroPginas());
...
class ComparatorNumeroPginas implements Comparator<Map.Entry<String, Livro>>{
